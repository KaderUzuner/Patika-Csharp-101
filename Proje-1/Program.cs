...
namespace Proje_1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            persons.Add(new PersonInfo("Ali", "Durmuş", 5457896432));
            persons.Add(new PersonInfo("Kenan", "Hardal", 5326475556));
            persons.Add(new PersonInfo("Halil", "Riyakar", 5317895236));
            persons.Add(new PersonInfo("Deniz", "Yalçın", 5456696666));
            persons.Add(new PersonInfo("Fatma", "Eren", 5364475655));
